package nickrout.roy.ui;

import static nickrout.roy.Pro.PRO;
...
import nickrout.roy.Pro;
import nickrout.roy.R;
import nickrout.roy.background.NightModeObservable;
import nickrout.roy.model.App;
import nickrout.roy.util.AppSorter;
import nickrout.roy.AppsSingleton;
import nickrout.roy.background.BroadcastReceivers;
import nickrout.roy.util.IconPackManager;
import nickrout.roy.util.LauncherUtil;
import nickrout.roy.background.LoadedObservable;
import nickrout.roy.util.NightModeUtil;
import nickrout.roy.util.Settings;
